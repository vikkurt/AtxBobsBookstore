    ...
    public static class ServicesSetup
    {
        ...
        private static string GetDatabaseConnectionString(ConfigurationManager configuration)
        {
            ...
            try
            {
                ...
                var dbPort = dbSecrets.Port;
                connString = $"Host={dbSecrets.Host};Port={dbPort};Database=BobsUsedBookStore;Username={dbSecrets.Username};Password={dbSecrets.Password};SSL Mode=Require;Trust Server Certificate=true";
            }
